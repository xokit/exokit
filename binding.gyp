      ...
      'conditions': [
        ['OS=="win"', {
          ...
          'include_dirs': [
            ...
            '<(module_root_dir)/deps/native-canvas-deps/include/effects',
            '<(module_root_dir)/deps/native-audio-deps/include',
            '<(module_root_dir)/deps/native-video-deps/include',
            '<(module_root_dir)/deps/native-openvr-deps/headers',
          ...
          'library_dirs': [
            ...
            '<(module_root_dir)/deps/native-audio-deps/lib/windows',
            '<(module_root_dir)/deps/native-video-deps/lib/win',
            '<(module_root_dir)/deps/native-openvr-deps/lib/win64',
          ...
          'copies': [
            {
              ...
              'files': [
                ...
                '<(module_root_dir)/deps/native-video-deps/lib/win/avformat-58.dll',
                '<(module_root_dir)/deps/native-video-deps/lib/win/avcodec-58.dll',
                '<(module_root_dir)/deps/native-video-deps/lib/win/avutil-56.dll',
                '<(module_root_dir)/deps/native-video-deps/lib/win/swscale-5.dll',
                '<(module_root_dir)/deps/native-video-deps/lib/win/swresample-3.dll',
                '<(module_root_dir)/deps/native-openvr-deps/bin/win64/openvr_api.dll',
              ]
            }
          ],
          'defines': [
        ...
        ['OS=="linux"', {
          ...
          'library_dirs': [
            ...
            '<(module_root_dir)/deps/native-audio-deps/lib/linux',
            '<(module_root_dir)/deps/native-video-deps/lib/linux',
            '<(module_root_dir)/deps/native-video-deps/lib/linux/libavformat',
            '<(module_root_dir)/deps/native-video-deps/lib/linux/libavcodec',
            '<(module_root_dir)/deps/native-video-deps/lib/linux/libavutil',
            '<(module_root_dir)/deps/native-video-deps/lib/linux/libswscale',
            '<(module_root_dir)/deps/native-video-deps/lib/linux/libswresample',
            '<(module_root_dir)/deps/native-openvr-deps/lib/linux64',
          ],
          'libraries': [
            '-lGL',
            '-lGLU',
          ...
          'ldflags': [
            ...
            '-Wl,-rpath,./deps/native-audio-deps/lib/linux',
            '-Wl,-rpath,./deps/native-video-deps/lib/linux/libavformat',
            '-Wl,-rpath,./deps/native-video-deps/lib/linux/libavcodec',
            '-Wl,-rpath,./deps/native-video-deps/lib/linux/libavutil',
            '-Wl,-rpath,./deps/native-video-deps/lib/linux/libswscale',
            '-Wl,-rpath,./deps/native-video-deps/lib/linux/libswresample',
            '-Wl,-rpath,./deps/native-openvr-deps/bin/linux64',
          ],
          'defines': [
            'NOMINMAX',
          ],
        ...
        ['OS=="mac"', {
          ...
          'library_dirs': [
            ...
            '<(module_root_dir)/deps/native-audio-deps/lib/macos',
            '<(module_root_dir)/deps/native-video-deps/lib/macos',
          ],
          'libraries': [
            '-framework OpenGL',
            '-framework Cocoa',
            ...
            '-lswscale',
            '-lswresample',
            '-F <(module_root_dir)/deps/native-openvr-deps/bin/osx64',
            '-framework OpenVR',
          ],
          'link_settings': {
            'libraries': [
              '-Wl,-rpath,./deps/native-audio-deps/lib/macos',
              '-Wl,-rpath,./deps/native-video-deps/lib/macos',
              '-Wl,-rpath,./deps/native-openvr-deps/bin/osx64',
              '-framework OpenVR',
            ],
          },
        }],
